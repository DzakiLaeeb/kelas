...
echo "<h2>Banners Table Structure</h2>";
...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<h3>Current structure of 'banners' table:</h3>";
        ...
        // Show data
        $result = $conn->query("SELECT * FROM banners LIMIT 10");
        if ($result->num_rows > 0) {
            echo "<h3>Sample data from 'banners' table:</h3>";
            echo "<table border='1'>";
            ...
            echo "<p>No data in 'banners' table.</p>";
        }
    } else {
